// Configurações
const PIX_KEY = '62.427.033/0001-70';
...
console.log('%c🐾 Refúgio da Tia Rê - Links 🐾', 'color: #FF6B35; font-size: 20px; font-weight: bold;');
console.log('%cObrigado por visitar nossa página!', 'color: #FF8C42; font-size: 14px;');
